...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('🔐 Auth callback triggered:', { type, has_token: !!token_hash });
    ...
    switch (type) {
      ...
      case 'email':
        ...
        console.log('➡️ Email confirmed, redirecting to login');
        return NextResponse.redirect(
      ...
      case 'email_change':
        ...
        console.log('➡️ Email change confirmed, redirecting to dashboard');
      ...
      default:
        ...
        console.log('➡️ Unknown auth type, redirecting to next:', next);
