...
export default function PESOSettingsPage() {
  ...
  return (
    <AdminLayout
      ...
      pageTitle="Settings"
      pageDescription="Manage your profile and digital signature for training certificates"
    >
      <Container>
        {/* Page Header */}
        <div className="mb-6">
          ...
          <p className="mt-2 text-gray-600">
            Manage your profile and digital signature for training certificates
          </p>
        </div>
